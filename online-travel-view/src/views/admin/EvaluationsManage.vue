    ...
    <el-row style="background-color: #FFFFFF; padding: 10px 0; border-radius: 5px;">
        <el-row style="padding: 10px; margin: 0 10px;">
            <el-row>
                ...
                <el-input size="small" style="width: 188px; margin-left: 5px; margin-right: 6px;"
                    v-model="evalustionsQueryDto.content" placeholder="Comment Content" clearable
        ...
        <el-row style="margin: 0 20px; border-top: 1px solid rgb(245,245,245);">
            <el-table row-key="id" @selection-change="handleSelectionChange" :data="tableData" style="width: 100%">
                ...
                <el-table-column prop="createTime" width="168" label="Commented At">
                    <template slot-scope="scope">
                        <span>{{ scope.row.createTime }}</span>
                    </template>
                </el-table-column>
                <el-table-column prop="userName" width="120" label="Commenter">
                    <template slot-scope="scope">
                        <span v-html="highlightKeyword(scope.row.userName)"></span>
                    </template>
                </el-table-column>
                <el-table-column prop="replierName" width="120" label="Replied To">
                    <template slot-scope="scope">
                ...
                <el-table-column prop="parentId" width="120" label="Level">
                    <template slot-scope="scope">
                        <i v-if="scope.row.parentId === null" style="margin-right: 5px;" class="el-icon-warning">
                        </i>
                        <i v-else style="margin-right: 5px; color: rgb(253, 199, 50);" class="el-icon-success">
                        </i>
                        <span v-if="scope.row.parentId === null"
                            style="text-decoration: underline; text-decoration-style: dashed;">
                            Parent Level
                        </span>
                        <span v-else>Child Level</span>
                    </template>
                </el-table-column>
        ...
        <el-dialog title="" :show-close="false" :visible.sync="reportDialog" width="35%">
            <div slot="title" style="padding: 25px 0 0 20px;">
                <span style="font-size: 18px; font-weight: 800;">Report Details</span>
            </div>
