    ...
    <el-row style="background-color: #FFFFFF;padding: 5px 0;border-radius: 5px;">
        <el-row style="padding: 10px;margin: 0 5px;">
            <el-row>
                <el-select @change="fetchFreshData" size="small" v-model="attractionTicketOrderQueryDto.payStatus"
                    style="margin-left: 5px;" placeholder="Pay Status">
        ...
        <el-row style="margin: 0 15px;border-top: 1px solid rgb(245,245,245);">
            <el-table :data="tableData" style="width: 100%">
                ...
                <el-table-column prop="useStatus" width="128" label="Payment Status">
    ...
    methods: {
        ...
        async batchDelete() {
            ...
            const confirmed = await this.$swalConfirm({
                title: 'Delete Attraction Order Data',
            ...
            if (confirmed) {
                try {
                    ...
                    console.error(`Error deleting attraction order information:`, e);
                }
            }
        },
        // 修改信息
        ...
        async fetchFreshData() {
            try {
                ...
                const response = await this.$axios.post('/attractionTicketOrder/query', params);
                const { data } = response;
