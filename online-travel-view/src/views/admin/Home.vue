    ...
    <div class="menu-container">
        <div class="menu-side" :class="{ 'menu-side-narrow': flag }">
            <div style="display: flex;align-items: center;">
                <Logo sysName="Travel backend" style="padding: 0 40px;margin: 10px 0;" :flag="flag" :bag="colorLogo" />
            </div>
        ...
        <el-dialog :show-close="false" :visible.sync="dialogOperaion" width="26%">
            ...
            <el-row style="padding: 10px 20px 20px 20px;">
                ...
                <el-row>
                    ...
                    <input class="input-title" v-model="userInfo.name" placeholder="userName">
                </el-row>
                <el-row>
                    <p style="font-size: 12px;padding: 3px 0;">
                        <span class="modelName">*User email</span>
                    </p>
                    <input class="input-title" v-model="userInfo.email" placeholder="email">
                </el-row>
            </el-row>
    ...
    methods: {
        async updateUserInfo() {
            try {
                ...
                this.dialogOperaion = false;
                this.$swal.fire({
                    title: 'Error when modifying personal infomation',
                    text: e,
                    icon: 'error',
                    showConfirmButton: false,
                    timer: 2000,
                });
                console.error(`Error when modifying personal infomatio:${e}`);
            }
        },
