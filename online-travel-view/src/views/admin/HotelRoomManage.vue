<template>
    <el-row style="background-color: #FFFFFF;padding: 5px 0;border-radius: 5px;">
        <el-row style="padding: 10px;margin: 0 5px;">
            <el-row>
                <el-select @change="fetchFreshData" size="small" v-model="hotelRoomQueryDto.hotelId"
                    placeholder="Affiliated Hotel">
        ...
        <el-dialog :show-close="false" :visible.sync="dialogOperation" width="28%">
            <div slot="title">
                <p class="dialog-title">{{ !isOperation ? 'Add Hotel Room' : 'Edit Hotel Room Information' }}</p>
            </div>
        ...
        async batchDelete() {
            ...
            if (confirmed) {
                try {
                    ...
                    console.error(`Hotel room information deletion exception: `, e);
                }
            }
        },
        // 修改信息
