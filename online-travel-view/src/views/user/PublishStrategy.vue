    ...
    <div style="background-color: rgb(249,249,249);">
        <div style="background-color: rgb(255,255,255);min-width: 700px;max-width: 900px;margin: 0 auto;padding: 20px 10px;">
            ...
            <div style="margin-top: 20px;text-align: center;">
                <el-button type="primary" class="customer" size="mini" @click="postInfo" round>Publish Now</el-button>
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    data() {
        return {
            ...
            cover: '',
            attractions: [],
            receiveContent: 'Type your Guide Here!'
        }
    },
    created() {
    ...
    methods: {
        ...
        async postInfo() {
            try {
                ...
                const { data } = await this.$axios.post('/attractionStrategy/save',this.data);
                if (data.code === 200) {
                    this.$message.success('Publish successful, awaiting review');
